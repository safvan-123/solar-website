...
//     fullName: "", // Changed from name to match Backend Schema
//     email: "",
//     phone: "",
//     projectType: "",
//     estimatedCapacity: "", // Changed from capacity to match Backend Schema
//     message: "",
//   });
...
//   const API_BASE_URL = "http://localhost:5000/api/contacts"; // Adjust port if needed
...
//                     <input
//                       type="text"
//                       name="fullName" // Matches state and Schema
...
//                   <select
//                     name="estimatedCapacity" // Matches state and Schema
//                     className="form-select"
...
//                     <option value="1-5kw">1-5 kW (Small Home)</option>
//                     <option value="5-10kw">5-10 kW (Large Home)</option>
//                     <option value="10-50kw">10-50 kW (Small Business)</option>
//                     <option value="50-100kw">
//                       50-100 kW (Medium Business)
//                     </option>
//                     <option value="100kw+">100+ kW (Large Commercial)</option>
//                   </select>
//                 </div> */}
...
//       {/* FAQ, Map, and Social Sections remain the same as your previous design... */}
//       {/* (Sections omitted for brevity, keep your original JSX here) */}
//     </div>
//   );
// };
